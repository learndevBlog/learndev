...
const Header = () => {
  return (
    <div className='bg-transparent w-full flex items-center border h-20 justify-between p-4 max-w-[1340px]'>
        <Logo mode='dark' labeled='h' />
        <p className='w-full max-w-[246px] leading-'>Aliquam augue dui, ultrices nec nulla id, laoreet iaculis arcu.</p>
